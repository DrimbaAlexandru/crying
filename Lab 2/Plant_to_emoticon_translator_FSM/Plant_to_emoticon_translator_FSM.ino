...
#define HUM_THRESHOLD_0 40
#define HUM_THRESHOLD_1 65
#define HUM_THRESHOLD_2 85
#define HUM_THRESHOLD_3 90
...
int calculateState(int percentage, int t0, int t1, int t2, int t3) {
  if(percentage <= t0 || t3 <= percentage) { return BAD; } 
  else if(t1 <= percentage && percentage <= t2) { return EXCELLENT; } 
  else { return GOOD; }
}
